...
git commit empty: "git commit --allow-empty -m '"
git commit message: "git commit -m '"
git commit amend: "git commit --amend\n"
git commit amend all: "git add . && git commit --amend\n"
git commit no verify: "git commit -n"
git [commit] all: "git add . && git commit -m '"
...
git rebase main: "git rebase -i main"
