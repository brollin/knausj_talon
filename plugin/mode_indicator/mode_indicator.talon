settings():
    ...
    # Red color for sleep mode
    user.mode_indicator_color_sleep = "800000"
    # Gold color for dictation mode
    user.mode_indicator_color_dictation = "ffd700"
    # CornflowerBlue color for mixed mode
    user.mode_indicator_color_mixed = "6495ed"
    # MediumSeaGreen color for command mode
