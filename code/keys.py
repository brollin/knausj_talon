...
default_alphabet = "air bat cap drum each fine gust harp igloo judge crunch look made near odd pit quench red sun trap urge valve wax plex yank zip".split(
    " "
)
